...
## v1.005 changes
- Season-at-once simulation with loading state
- No age or starting-team selection added
- League finish shown at season end
- OVR can rise, fall, or stay the same
- European trophy award is mutually exclusive
- Next Season progression button
- No reset button; Start New Career appears at retirement
